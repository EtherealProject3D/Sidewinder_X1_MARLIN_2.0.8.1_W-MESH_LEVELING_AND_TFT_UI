...
#define STRING_CONFIG_H_AUTHOR "(Ethereal Project SIDEWINDER X1 W/MANUAL MESH)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  31.58
  #define DEFAULT_bedKi   6.12
  #define DEFAULT_bedKd  108.7
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 435 }
